...
(function(){
  ...
  /* ========================================================
     ...
     Шесть причин сказать «да». На виду две первые — деньги и
     время; остальные четыре ждут того, кому их не хватило.
     Три шага срока не трогаются: это и есть предложение.
     ======================================================== */
  fold('s06', '.gains > .gain', 2, 'Что ещё вы получите');

  /* ========================================================
     07. ЧТО МОЖЕТ СМУЩАТЬ

     Пять сомнений. Два первых — про деньги вперёд и про
     результат — остаются открытыми: из-за них закрывают
     страницу. Остальные ждут того, у кого они есть.
     ======================================================== */
  fold('s07', '.aud > li', 2, 'Ещё три сомнения');
